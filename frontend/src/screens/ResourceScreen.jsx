            ...
            <Card>
              <Card.Body>
                <p>
                  <a
                    className="link-dark"
                    href="https://github.com/csalpha/ecommerce"
                    target="_blank"
                  >
                    Carlos Serôdio - Github
                  </a>
                </p>
                <p>
                  <a
              ...
              <Card.Body>
                <p>
                  <a
                    ...
                    target="_blank"
                  >
                    Digital Wallets, Money Management, and More | PayPal{' '}
                  </a>
                </p>
                <p>
                  <a
            ...
            <Card>
              <Card.Body>
                <p>
                  <a
                    className="link-dark"
                    href="https://developers.google.com/maps/documentation/javascript/react-map"
                    target="_blank"
                  >
                    Adding a Map and Markers to a React Application  |  Maps
                    JavaScript API  |  Google Developers
                  </a>
                </p>
                <p>
                  <a
        ...
        <Row>
          <Col md={4}>
            ...
            <p>
              <a
                className="link-dark"
                href="https://react-responsive-carousel.js.org"
                target="_blank"
              >
